...
/*
        ...
        // result [0,-2]
*/
        System.out.println("Произведение: " + hw.multiple(new ArrayDeque<>(Arrays.asList(5,2)), new ArrayDeque<>(Arrays.asList(4))));
        System.out.println("Сумма: " + hw.sum( new ArrayDeque<>(Arrays.asList(5,-2)), new ArrayDeque<>(Arrays.asList(5))));
